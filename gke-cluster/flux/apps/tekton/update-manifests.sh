...
curl -Lo interceptors.yaml https://storage.googleapis.com/tekton-releases/triggers/latest/interceptors.yaml
curl -Lo pruner.yaml https://infra.tekton.dev/tekton-releases/pruner/latest/release.yaml
